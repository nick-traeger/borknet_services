...
public interface Command
{
	...
	void parse_help(Core C, V Bot, String numeric, String botnum, String username, boolean operator);
	void showcommand(Core C, V Bot, String numerc, String botnum, String username, boolean operator);
}